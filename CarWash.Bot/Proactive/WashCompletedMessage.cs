...
namespace CarWash.Bot.Proactive
{
    ...
    public class WashCompletedMessage : ProactiveMessage<ReservationServiceBusMessage>
    {
        ...
        public WashCompletedMessage(CarWashConfiguration configuration, StateAccessors accessors, IAdapterIntegration adapterIntegration, IHostingEnvironment env, BotServices services, TelemetryClient telemetryClient)
            : base(accessors, adapterIntegration, env, services, configuration.ServiceBusQueues.BotWashCompletedQueue, new Dialog[] { AuthDialog.LoginPromptDialog(), new FindReservationDialog(telemetryClient) }, telemetryClient)
        {
